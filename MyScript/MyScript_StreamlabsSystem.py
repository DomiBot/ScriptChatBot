...
def Execute(data):
	...
	if data.IsChatMessage() and data.GetParam(0).lower() != "!list" and (Parent.HasPermission(data.User, permission, "")) and ((liveOnlyNotification and Parent.IsLive()) or (not liveOnlyNotification)) and notification:
		outputMessage = ""
		userId = data.User			
